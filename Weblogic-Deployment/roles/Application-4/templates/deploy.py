...
deploy('{{ecx-liferay-autosetup-1.0.0}}', '/apps/oracle/domains/applications/{{ecx-liferay-autosetup-1.0.0}}', targets='{{cluster_server}}'
startApplication('ecx-liferay-autosetup-1.0.0')
